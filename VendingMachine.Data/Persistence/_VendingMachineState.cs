...
{
    public class _VendingMachineState
    {
        ...
        /*public _VendingMachineState()
        {
        }

        public _VendingMachineState(IVendingMachine vendingMachine, string name = null)
        {
            Name = name;
